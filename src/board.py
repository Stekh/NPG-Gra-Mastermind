...
class Board:
    ...
    def __init__(self, rows: int, cols: int, x: float, y: float, board_color: pg.color, pin_color: pg.color):
        ...
        self.holes=[[ui.Button(init_pos_x + i*CELL_WIDTH,init_pos_y + j*CELL_HEIGHT,HOLE_WIDTH,HOLE_HEIGHT,[(120, 120, 120)],(120, 0, 120)) for i in range(0,cols)] for j in range(0,rows)]
